    ...
    <div class="card-body">
      ...
      <form method="post" action="create_auction_result.php">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" id="auctionDetails" rows="4" name = "item_desc"></textarea>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
	        <div class="input-group">
              ...
              <input type="number" class="form-control" id="auctionStartPrice" name = "starting_price">
            </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="datetime-local" class="form-control" id="auctionEndDate" name = "expirationDate">
